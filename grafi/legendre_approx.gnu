...
#set samples 10000
filename1 = '../thomson/legendre_napake_85.txt'
filename2 = '../fibonacci/legendre_napake_85.txt'
filename3 = '../random/legendre_napake_85.txt'
...
set title 'Izračunana varianca z Legendrovimi polinomi za $N=85$'
set ylabel '$\sigma_N^2 (\vartheta)$' enhanced
set xlabel '$\vartheta/\pi$' enhanced

plot filename1 w l ls 1 title 'Thomson',\
filename2 w l ls 2 title 'Fibonacci',\
filename3 w l ls 3 title 'Naključni'
